...
export const metadata: Metadata = {
  title: "RPRT Sports + Talent Management - Elite Entertainment Industry Services",
  description: "Premier talent management company handling everything from career management to contract negotiations for elite athletes and entertainers. Film/TV production, PR, and brand consulting.",
  keywords: "talent management, sports management, entertainment industry, film production, product placement, brand consulting, Hollywood, athlete management",
  metadataBase: new URL("https://rp-rt.com"),
  alternates: {
    canonical: "https://rp-rt.com"
  },
  openGraph: {
    title: "RPRT Sports + Talent Management - Elite Entertainment Services",
    description: "Premier talent management for elite athletes and entertainers. Comprehensive services from career management to film production and brand consulting.",
    url: "https://rp-rt.com",
    siteName: "RPRT Sports + Talent Management",
    images: [{
      url: "https://images.pexels.com/photos/7715790/pexels-photo-7715790.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
      alt: "RPRT talent management services"
    }],
    type: "website"
  },
  twitter: {
    ...
    title: "RPRT Sports + Talent Management - Elite Entertainment Services",
    description: "Premier talent management for elite athletes and entertainers. Comprehensive entertainment industry services.",
    images: ["https://images.pexels.com/photos/7715790/pexels-photo-7715790.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
